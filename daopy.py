...
directory = '/home/lakeclean/Documents/FUT/K2_287/FUT_Data/test2'
allNames_0 = glob.glob(f'{directory}/*.fits')
allNames = []
for i in allNames_0:
    allNames.append(i[len(directory)+1:-5])
